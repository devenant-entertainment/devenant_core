...
namespace Devenant
{
    ...
    public abstract class Menu<T> : MonoBehaviour where T : Menu<T>
    {
        ...
        public RectTransform rectTransform { get { if(_rectTransform == null) _rectTransform = GetComponent<RectTransform>(); return _rectTransform; } private set { _rectTransform = value; } }
        private RectTransform _rectTransform;

        public CanvasGroup canvasGroup { get { if(_canvasGroup == null) _canvasGroup = GetComponent<CanvasGroup>(); return _canvasGroup; } private set { _canvasGroup = value; } }
