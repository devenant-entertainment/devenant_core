...
namespace Devenant
{
    public class ApplicationManager : Singleton<ApplicationManager>
    {
        ...
        public void Initialize(SOApplication application, SOBackend backend, Action callback = null)
        {
            ...
            async void Setup(Action callback)
            {
                ...
                {
                    AudioSettingsManager.instance.Setup();
...
#endif
                        LocalizationSettingsManager.instance.Setup(() =>
                        {
