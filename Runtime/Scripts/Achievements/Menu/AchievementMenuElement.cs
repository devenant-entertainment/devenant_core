...
namespace Devenant
{
    public class AchievementMenuElement : MonoBehaviour
    {
        ...
        public void Setup(Achievement achievement)
        {
            ...
            nameText.text = LocalizationSettingsManager.instance.Translate("Achievement", achievement.name + "_name");
            descriptionText.text = LocalizationSettingsManager.instance.Translate("Achievement", achievement.name + "_description");
